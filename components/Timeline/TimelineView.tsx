...
const TimelineView: React.FC<TimelineViewProps> = ({
        ...
        <View style={styles.activityDetails}>
          ...
          <View style={styles.activityMeta}>
            <View style={styles.metaItem}>
              ...
              <Text style={styles.metaText}>{getDurationText(item.duration)}</Text>
            </View>
            {item.scenarios && (
              <View style={styles.metaItem}>
                <Ionicons name="layers-outline" size={12} color={colors.text.secondary} />
  ...
  if (!activities || activities.length === 0) {
    return (
      <View style={styles.emptyContainer}>
        <Ionicons name="history" size={48} color={colors.text.tertiary} />
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        data={dateGroups}
        renderItem={({ item: [date, items] }) => renderDateGroup(date, items as TimelineActivity[])}
