...
import { vocabularyService, VocabularyWord } from '@/service/VocabularyService';
...
export const VocabularyPopup: React.FC<VocabularyPopupProps> = ({ courseStatus }) => {
  ...
  const markVocabularyAsCompleted = async () => {
    ...
    try {
      const currentWeek = courseStatus.course.currentWeek;
      const currentDay = courseStatus.course.currentDay;
      await vocabularyService.markVocabularyAsCompleted(currentWeek, currentDay);
      setShowPopup(false);
    } catch (err) {
        ...
        <View style={styles.modalContent}>
          ...
          {currentWord && (
            <ScrollView style={styles.wordContent}>
              ...
              <Text style={styles.wordDefinition}>{currentWord.definition}</Text>
              {currentWord.example && (
                <Text style={styles.wordExample}>Example: {currentWord.example}</Text>
              )}
            </ScrollView>
          )}
