 ...
 * 
 * Wraps the practice page with gradient visualizers that respond to voice activity.
...
export const useVoiceVolume = () => {
  ...
  if (!context) {
    throw new Error('useVoiceVolume must be used within PracticeVisualizerLayout');
  }
  return context;
};
...
export function PracticeVisualizerLayout({ children }: PracticeVisualizerLayoutProps) {
