          ...
          <View style={styles.levelCard}>
            ...
            <View style={styles.levelInfo}>
              <Text style={styles.levelTitle}>
                Level {achievements.level.current} - {courseService.getLevelName(achievements.level.current)}
              </Text>
          ...
          <View style={styles.streakCard}>
            ...
            <View style={styles.streakInfo}>
              <Text style={styles.streakTitle}>
                {analytics.progress.current_streak} Day Streak
              </Text>
              <Text style={styles.streakSubtext}>
                {analytics.progress.current_streak >= 7
                  ? 'Keep it up!'
                  : `${analytics.progress.current_streak} days`}
              </Text>
            </View>
          </View>
        )}
