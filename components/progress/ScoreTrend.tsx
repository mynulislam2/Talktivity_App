            ...
            {analytics.skillTrends.map((trend, index) => {
              ...
              return (
                <View key={index} style={styles.chartBar}>
                  ...
                  />
                  <Text style={styles.chartLabel}>Week {trend.week_number}</Text>
                  <Text style={styles.chartValue}>{Math.round(trend.avg_score)}</Text>
                </View>
              );
            })}
          </View>
            ...
            {analytics.weeklyExams.map((exam, index) => {
              ...
              return (
                <View key={index} style={styles.chartBar}>
                  ...
                  <Text style={styles.chartValue}>{Math.round(exam.exam_score)}</Text>
                </View>
              );
            })}
          </View>
          ...
          <View style={styles.selector}>
            ...
            >
              <Text
                style={[
                  ...
                  scoreType === 'Quiz Scores' && styles.selectorButtonTextActive,
                ]}
              >
                Quiz Scores
              </Text>
            ...
            >
              <Text
                style={[
                  styles.selectorButtonText,
                  scoreType === 'Exam Scores' && styles.selectorButtonTextActive,
                ]}
              >
                Exam Scores
              </Text>
