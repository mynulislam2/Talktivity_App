...
export function SummerySection({ analytics, achievements }: SummerySectionProps) {
  return (
        ...
        <View style={styles.header}>
          ...
          {analytics && (
            <View style={styles.streakBadge}>
              <Text style={styles.streakText}>{analytics.progress.current_streak} Day Streak</Text>
            </View>
          )}
        </View>
        <View style={styles.grid}>
          ...
          <View style={styles.gridItem}>
            <Text style={[styles.gridValue, styles.valuePurpleLight]}>
              {analytics
                ? courseService.formatSpeakingTime(analytics.progress.total_speaking_time)
                : '...'}
            </Text>
          ...
          <View style={styles.xpSection}>
            ...
            <View style={styles.xpProgress}>
              <View style={styles.xpProgressLabels}>
                <Text style={styles.xpProgressLabel}>Level {achievements.level.current}</Text>
                <Text style={styles.xpProgressLabel}>
                  {achievements.level.xpProgress}% to Level {achievements.level.current + 1}
                </Text>
              </View>
            ...
            <View style={styles.xpBreakdown}>
              <View style={styles.xpBreakdownItem}>
                ...
                <Text style={[styles.xpBreakdownValue, styles.valueGreen]}>
                  {Math.floor((achievements.stats.totalSpeakingTime || 0) / 60)} min
                </Text>
                <Text style={styles.xpBreakdownXP}>
                  {Math.floor((achievements.stats.totalSpeakingTime || 0) / 60) * 2} XP
                </Text>
              </View>
              <View style={styles.xpBreakdownItem}>
