...
export function PlanCard({
  ...
  const proPlanDailyTalkTime = process.env.EXPO_PUBLIC_PRO_PLAN_DAILY_TALK_TIME || "60";
  const basicPlanScenarios = process.env.EXPO_PUBLIC_BASIC_PLAN_SCENARIOS || "5";
  const proPlanScenarios = process.env.EXPO_PUBLIC_PRO_PLAN_SCENARIOS || "unlimited";
    ...
    return (
      <View style={[styles.card, styles.freeTrialCard]}>
        ...
        <View style={styles.featuresList}>
          <FeatureItem text={`${basicPlanDailyTalkTime} minutes daily talk time`} />
  ...
  if (isBasic) {
    return (
      <View style={[styles.card, isRecommended && styles.recommendedCard]}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            style={[styles.primaryButton, isRecommended && styles.recommendedButton]}
            onPress={handleClick}
          >
            <Text style={styles.primaryButtonText}>Buy Now - ৳{basicPlanPrice}</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
  ...
  if (isPro) {
    return (
      <View style={styles.card}>
        ...
        <View style={styles.featuresList}>
          <FeatureItem text={`${proPlanDailyTalkTime} minutes daily talk time`} />
