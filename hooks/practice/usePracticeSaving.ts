/**
 * usePracticeSaving Hook
 * 
 * Manages session saving state and lifecycle.
 * Reuses the same logic as useSessionSaving from call hooks.
 */

import { useState, useCallback } from 'react';

export type PracticeSessionSaveState = 'SAVING_CONVERSATION' | 'SESSION_SAVE_FAILED' | null;
...
export function usePracticeSaving(): UsePracticeSavingReturn {
  ...
  const [sessionSaveState, setSessionSaveState] = useState<PracticeSessionSaveState>(null);
