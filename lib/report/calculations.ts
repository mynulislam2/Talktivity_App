 ...
 */
export function calculateRadarData(overallScores: OverallScores | null): RadarDataPoint[] {
  if (!overallScores) {
    return [];
  }
  ...
  return [
    {
      ...
      description: 'Fluency is the ability to speak smoothly and confidently without unnecessary pauses.',
    },
    {
      subject: 'Vocabulary',
      A: overallScores.vocabulary,
      ...
      description: 'Vocabulary is the range of words you know and can use to express your thoughts clearly.',
    },
    {
      subject: 'Grammar',
      A: overallScores.grammar,
      ...
      description: 'Grammar is the set of rules that structure sentences correctly and meaningfully.',
    },
    {
      subject: 'Discourse',
      A: overallScores.discourse,
      ...
      description: 'Discourse refers to how ideas are connected and organized in longer speech or writing.',
    },
  ];
}