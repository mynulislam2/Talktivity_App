/**
 * Listening Quiz Card Component (React Native)
 *
...
interface ListeningQuizCardProps {
  ...
  const handleStart = async () => {
    try {
      ...
      (navigation as any).navigate('LearningStack', {
        screen: 'ListeningQuizScreen',
        params: {
          topicId: course.todayListeningTopic?.id || '1',
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.cardHeader}>
          <Text style={styles.cardTitle}>Listening Quiz</Text>
          {completed && (
            <Ionicons
        ...
        <Text style={styles.cardDescription}>
          Take a quiz to test your listening comprehension
        </Text>
        {completed ? (
          ...
          <View style={styles.lockedBadge}>
            ...
            <Text style={styles.lockedText}>Complete Listening Zone first</Text>
          </View>
        ) : (
          <TouchableOpacity
