...
const ss = StyleSheet.create({
  ...
  subtitle: { fontSize: 14, color: tokens.color.text.secondary },
  statSpace: { gap: 16 },
  desc: { fontSize: 14, color: tokens.color.text.secondary, lineHeight: 20 },
  levelRow: {
    flexDirection: 'row',
  ...
  levelLabel: { fontSize: 14, color: tokens.color.text.secondary },
