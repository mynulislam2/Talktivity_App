...
export const CURRENT_LEVEL_OPTIONS: StepOption[] = [
  {
    id: 'beginner',
    text: 'Beginner: I can buy things & order food',
    icon: '🔤',
  },
  {
    id: 'intermediate',
    text: 'Intermediate: I can have simple conversations',
    icon: '💬',
  },
  {
    id: 'upper',
    text: 'Upper-Intermediate: I can explain my opinions',
    icon: '🗣️',
  },
  {
    id: 'advanced',
    text: 'Advanced: I speak confidently in any situation',
    icon: '🏆',
  },
];
