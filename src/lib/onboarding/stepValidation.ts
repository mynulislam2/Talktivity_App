...
> = {
  ...
  0: (selections) =>
    selections.skillToImprove !== null && selections.skillToImprove !== '',

  // Step 1: Language statement
  1: (selections) =>
    selections.languageStatement !== null &&
    selections.languageStatement !== '',
  ...
  3: (selections) =>
    selections.speakingFeelings !== null && selections.speakingFeelings !== '',

  // Step 4: Speaking frequency
  4: (selections) =>
    selections.speakingFrequency !== null &&
    selections.speakingFrequency !== '',
  ...
  7: (selections) =>
    Array.isArray(selections.currentLearningMethods) &&
    selections.currentLearningMethods.length > 0,

  // Step 8: Current level
  8: (selections) =>
    selections.currentLevel !== null && selections.currentLevel !== '',

  // Step 9: Native language
  9: (selections) =>
    selections.nativeLanguage !== null && selections.nativeLanguage !== '',

  // Step 10: Known words 1 (array)
  10: (selections) =>
    Array.isArray(selections.knownWords1) && selections.knownWords1.length > 0,

  // Step 11: Known words 2 (array)
  11: (selections) =>
    Array.isArray(selections.knownWords2) && selections.knownWords2.length > 0,

  // Step 12: Interests (array)
  12: (selections) =>
    Array.isArray(selections.interests) && selections.interests.length > 0,

  // Step 13: English style
  13: (selections) =>
    selections.englishStyle !== null && selections.englishStyle !== '',

  // Step 14: Tutor style (array)
  14: (selections) =>
    Array.isArray(selections.tutorStyle) && selections.tutorStyle.length > 0,
};
