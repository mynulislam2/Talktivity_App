      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            At Talktivity, we believe everyone should have access to quality
            English learning resources. Our mission is to make English
            conversation practice fun, affordable, and accessible to learners
            worldwide through AI-powered, interactive voice lessons.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            We envision a world where language barriers no longer limit personal
            growth, career opportunities, and global connections. We're building
            the most engaging and effective English learning platform powered by
          ...
          <View style={styles.featuresList}>
            ...
            <View style={styles.featureItem}>
              ...
              <View style={styles.featureContent}>
                ...
                <Text style={styles.featureDesc}>
                  Practice conversations across real-world scenarios and
                  situations
                </Text>
              </View>
            </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            ...
            language experts committed to making English learning accessible and
        ...
        <View style={styles.card}>
          ...
          <View style={styles.socialLinks}>
            ...
            <TouchableOpacity
              style={styles.socialButton}
              onPress={() =>
                handleSocialPress('https://instagram.com/talktivity')
              }
            >
            ...
            <TouchableOpacity
              style={styles.socialButton}
              onPress={() =>
                handleSocialPress('https://linkedin.com/company/talktivity')
              }
            >
