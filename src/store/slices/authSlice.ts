...
export const selectLoginLoading = (state: { auth: AuthState }) =>
  state.auth.loginLoading;
export const selectLoginError = (state: { auth: AuthState }) =>
  state.auth.loginError;
export const selectRegisterLoading = (state: { auth: AuthState }) =>
  state.auth.registerLoading;
export const selectRegisterError = (state: { auth: AuthState }) =>
  state.auth.registerError;
export const selectGoogleAuthLoading = (state: { auth: AuthState }) =>
  state.auth.googleAuthLoading;
export const selectGoogleAuthError = (state: { auth: AuthState }) =>
  state.auth.googleAuthError;
