 ...
 * Selectors
 */
export const selectTopicsCategories = (state: { topics: TopicsState }) =>
...
export const selectTopicsLoading = (state: { topics: TopicsState }) =>
  state.topics.loading;
export const selectTopicsError = (state: { topics: TopicsState }) =>
  state.topics.error;
export const selectIsCreatingTopic = (state: { topics: TopicsState }) =>
  state.topics.creating;
