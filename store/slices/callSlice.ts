...
const callSlice = createSlice({
  ...
  reducers: {
     ...
     */
    setSessionState: (state, action: PayloadAction<Partial<CallSessionState>>) => {
      state.sessionState = {
        ...state.sessionState,
        ...action.payload,
      };
     ...
     */
    setConnectionDetails: (state, action: PayloadAction<ConnectionDetails | null>) => {
  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(loadCallStatus.rejected, (state, action) => {
        state.callStatusLoading = false;
        state.callStatusError = action.payload as string || 'Failed to load call status';
      });
  },
});
...
export const selectSessionState = (state: { call: CallState }) => state.call.sessionState;
export const selectConnectionDetails = (state: { call: CallState }) => state.call.connectionDetails;
export const selectCallStatusLoading = (state: { call: CallState }) => state.call.callStatusLoading;
export const selectCallStatusError = (state: { call: CallState }) => state.call.callStatusError;
