 ...
 */
export function formatLocalDate(dateInput: string | number | Date, options?: Intl.DateTimeFormatOptions): string {
 ...
 */
export function formatLocalTime(dateInput: string | number | Date, options?: Intl.DateTimeFormatOptions): string {
  const date = new Date(dateInput);
 ...
 */
export function formatLocalDateTime(dateInput: string | number | Date, options?: Intl.DateTimeFormatOptions): string {
  const date = new Date(dateInput);
